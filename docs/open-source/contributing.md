...
[the issue page](https://github.com/cgwire/kitsu/issues) of the Kitsu repository.
...
Please have a look at [the development environment quickstart guide](/open-source/development-environment-quickstart) to start contributing code.
