...
![Permissions button](./img/slack_create_app_03.png)

In the scopes section, add the required permission:

![Add scope](./img/slack_create_app_04.png)

The required permission scope is `chat:write:bot`:

![Permission scope](./img/slack_create_app_05.png)
...
![Install app](./img/slack_create_app_06.png)

Confirm the installation:

![Confirm installation](./img/slack_create_app_07.png)
...
![Find member ID](./img/find-member-id.png)

![Member ID](./img/member-id.png)

In your Kitsu profile, set the Slack notifications to "on" and enter your Slack nickname:

![Configure Slack notifications](./img/slack_configuration.png)

You can now enjoy notifications directly in your Slack workspace!

![Slack notifications](./img/slack_kitsu_notifications.png)
